...
def get_args():
    ...
    parser.add_argument("--checkpoint", type=str, default="https://github.com/mrmedrano81/197z-object-detection/releases/tag/v1.0/kwst_pre.pt")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        mel = einops.rearrange(mel, 'c h (p w) -> c p (h w)', p=16)
